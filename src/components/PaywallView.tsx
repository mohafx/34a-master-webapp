        ...
        <div className={`flex flex-col h-full bg-[#F2F4F6] dark:bg-slate-950 ${isEmbedded ? 'w-full' : 'sm:rounded-[3rem] border border-white/50 dark:border-slate-800 shadow-2xl overflow-hidden'}`}>
                ...
                {successMode ? (
                    ...
                    <div className="bg-white dark:bg-slate-900 p-4 rounded-3xl shadow-sm">
                        <button
                            ...
                            className="mb-4 text-sm text-slate-500 flex items-center gap-1"
                        >
                            ← Zurück
                        </button>
                    ...
                    <div className={`md:grid md:grid-cols-2 md:gap-x-12 md:gap-y-6 md:items-start max-w-full ${isEmbedded ? 'px-4 sm:px-6 pt-4 pb-6' : ''}`}>
                        ...
                        <div className="space-y-6">
                            <div className="relative mb-6 mt-10">
                                <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20 flex items-center gap-1.5 bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-1.5 rounded-full border-2 border-[#F2F4F6] dark:border-slate-950 shadow-lg">
                                ...
                                <div className="relative bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/60 dark:border-slate-800 overflow-hidden pt-7">
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full ${valueStackOpen ? 'bg-slate-100 text-slate-600' : 'bg-blue-50 text-blue-600'}`}>
                                    ...
                                    <div className={`grid transition-all duration-500 ease-out ${valueStackOpen ? 'grid-rows-[1fr] opacity-100 mt-5 pt-5 border-t border-slate-100' : 'grid-rows-[0fr] opacity-0'}`}>
                                                            ...
                                                            {group.items.map((item: any, i) => (
                                                                <div key={i} className="flex items-start gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors">
                                                                    <div className="relative shrink-0 mt-0.5">
                                                                        ...
                                                                        <div className="absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-full bg-blue-500 border-2 border-white flex items-center justify-center">
                                                                    ...
                                                                    <div className="flex-1 pt-0.5">
                                                                        <div className="flex items-center gap-2 mb-0.5">
                                                                            ...
                                                                            <span className="bg-slate-100 dark:bg-slate-800 text-slate-500 text-[9px] font-bold px-1.5 py-0.5 rounded-md uppercase">{item.badge}</span>
                                                                        </div>
                                                                        <p className="text-[11px] text-slate-500 leading-snug">{item.descDE}</p>
                        ...
                        {/* Plans Column */}
                        <div className="space-y-6">
                            <div className="mb-6 rounded-[2rem] transition-all relative overflow-hidden group p-0.5 bg-gradient-to-br from-blue-500 to-blue-600 shadow-xl shadow-blue-500/20 scale-[1.02]">
                                <div className="rounded-[1.85rem] overflow-hidden bg-white dark:bg-slate-900">
                                    <div className="relative bg-gradient-to-br from-[#F3F7FF] to-[#EEF4FF] dark:from-slate-900 dark:to-slate-900 p-5 border-b border-blue-100/70">
                                        <div
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-blue-600">
                                                    <Rocket size={18} className="fill-blue-500/20" />
                                                </div>
                                                <div className="flex flex-col text-left">
                                                    <p className="text-[11px] font-extrabold text-blue-600 uppercase tracking-[0.04em]">Nur für kurze Zeit</p>
                                                </div>
                                            </div>
                                            <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full transition-all ${earlyAdopterOpen ? 'bg-blue-100 text-blue-700' : 'bg-white shadow-sm text-blue-600'}`}>
                                        ...
                                        <div className={`grid transition-all duration-500 ease-out ${earlyAdopterOpen ? 'grid-rows-[1fr] opacity-100 mt-5 pt-5 border-t border-blue-200/70' : 'grid-rows-[0fr] opacity-0'}`}>
                                            <div className="overflow-hidden space-y-4">
                                                <div className="flex items-start gap-3">
                                                    <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shrink-0"><MessageCircle size={14} /></div>
                                                    <div><p className="text-[13px] font-bold">WhatsApp-Support</p><p className="text-[11px] text-slate-500">Direkter Draht • Antwort binnen 24h</p></div>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shrink-0"><Infinity size={14} /></div>
                                                    <div><p className="text-[13px] font-bold">Einmalzahlung statt Abo</p><p className="text-[11px] text-slate-500">6 Monate voller Zugriff ohne Abo-Falle</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-5 flex items-center justify-between">
                                        <div className="flex flex-col gap-2">
                                            <div className="flex items-baseline gap-2">
                                                <span className="font-black text-[18px]">€49</span>
                                                <span className="font-bold text-[10px] text-slate-400">statt <span className="line-through">€99</span></span>
                                            </div>
                                            <p className="font-black text-[10px] uppercase tracking-tight">Einmalzahlung für 6 Monate</p>
                                        </div>
                            ...
                            <div className="mt-6">
                                <div className={`mb-4 flex items-start gap-3 px-1 transition-all ${shakeTerms ? 'animate-shake' : ''}`}>
                                    <button
                                        ...
                                        className={`w-4 h-4 rounded border shrink-0 mt-0.5 ${hasAcceptedTerms ? 'bg-blue-600 border-blue-600' : 'border-slate-300'}`}
                                    >
                                        {hasAcceptedTerms && <Check size={12} strokeWidth={4} className="text-white" />}
                                    </button>
                                    <p className="text-[11px] text-slate-500 cursor-pointer" onClick={() => setHasAcceptedTerms(!hasAcceptedTerms)}>
                                        Widerrufsrecht: Ich willige in sofortigen Zugang ein und bestätige, dass mein <a href="#/agb" target="_blank" className="text-blue-600 font-medium">Widerrufsrecht</a> mit Nutzungsbeginn erlischt.
                                    </p>
                                </div>

                                {error && (
                                    <div className="mb-4 p-3 rounded-xl bg-red-50 border border-red-200 text-red-600 text-sm flex gap-2">
                                ...
                                <div className="flex flex-col items-center gap-1 mb-6 animate-fadeIn">
                                    <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-1.5 text-[12px] sm:text-[13px] font-extrabold text-slate-700 dark:text-slate-300 bg-white/50 dark:bg-slate-800/50 px-4 py-2 rounded-2xl border border-slate-200/50 dark:border-slate-700/50">
                                    ...
                                    {showArabic && (
                                        <p className="text-[10px] text-slate-400 font-bold mt-0.5" dir="rtl">
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#2563EB] text-white font-black py-4 rounded-2xl shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all flex flex-col items-center justify-center gap-0.5"
                                >
                                    <span className="text-[15px]">{loading ? 'Wird geladen...' : 'Jetzt Zugang freischalten'}</span>
                                    {showArabic && <span className="text-[10px] opacity-80" dir="rtl">فتح الوصول الآن</span>}
                                </button>

                                {/* Payment Logos */}
                                <div className="mt-8 opacity-40 grayscale flex flex-col items-center gap-4">
                                    <div className="flex items-center gap-1.5">
                                        <ShieldCheck size={14} />
            ...
            {isEmbedded && !clientSecret && !successMode && onClose && (
                <div className="px-6 pt-2 pb-6 flex flex-col items-center">
                    <button 
                        onClick={onClose}
                        className="text-slate-500 text-[13px] font-medium hover:text-slate-700 underline underline-offset-4 decoration-slate-200"
                    >
